...
import digitalTransform from '../image/digital_new.jpg'
...
import sapbackground from '../image/sap_detail.jpg'
import apidetail from '../image/api-integration_detail.png'
import dynamicdetail from '../image/dynamics_detail.jpg'
import oracledetail from '../image/oracle_detail.jpeg'
import applicatondevdetail from '../image/Application-development-crop.jpg'
...

    {
        array1 && array1?.map((item)=>{
         ...
         { <h1>aaa</h1>
           ...
           }}  className='detail_case-st-background'>
        </div>
